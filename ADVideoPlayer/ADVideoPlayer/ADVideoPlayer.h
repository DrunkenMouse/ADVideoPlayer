...
//FOUNDATION_EXPORT NSString *const kADPlayerStateChangeNotification;
//FOUNDATION_EXPORT NSString *const kADPlayerProgressChangedNotification;
//FOUNDATION_EXPORT NSString *const kADPlayerLoadProgressChangedNotification;
